...
function AllProducts({id,category,avatar,description,name,price}) {
  const navigate = useNavigate();
    ...
    const handleChange=(category)=>{
      ...
      navigate(`/SpecificProduct/${category}`)
      
    }
  return (
    <Box display="flex" flexDirection="column" m="5px" bgColor="white" p="10"> 
